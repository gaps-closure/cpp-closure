; ModuleID = '/home/bflin/gaps/cpp-closure/build/capo/tests/cpp/hello_world.cpp'
source_filename = "/home/bflin/gaps/cpp-closure/build/capo/tests/cpp/hello_world.cpp"
...
define internal void @__cxx_global_var_init() #0 section ".text.startup" !dbg !863 {
  call void @_ZNSt8ios_base4InitC1Ev(%"class.std::ios_base::Init"* noundef nonnull align 1 dereferenceable(1) @_ZStL8__ioinit), !dbg !865
  %1 = call i32 @__cxa_atexit(void (i8*)* bitcast (void (%"class.std::ios_base::Init"*)* @_ZNSt8ios_base4InitD1Ev to void (i8*)*), i8* getelementptr inbounds (%"class.std::ios_base::Init", %"class.std::ios_base::Init"* @_ZStL8__ioinit, i32 0, i32 0), i8* @__dso_handle) #3, !dbg !867
  ret void, !dbg !865
}
...
define dso_local noundef i32 @main() #4 !dbg !868 {
  %1 = alloca i32, align 4
  %2 = alloca i32, align 4
  store i32 0, i32* %1, align 4
  call void @llvm.dbg.declare(metadata i32* %2, metadata !870, metadata !DIExpression()), !dbg !871
  store i32 0, i32* %2, align 4, !dbg !871
  %3 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8* noundef getelementptr inbounds ([12 x i8], [12 x i8]* @.str, i64 0, i64 0)), !dbg !872
  %4 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSolsEPFRSoS_E(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) %3, %"class.std::basic_ostream"* (%"class.std::basic_ostream"*)* noundef @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_), !dbg !873
  ret i32 0, !dbg !874
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_hello_world.cpp() #0 section ".text.startup" !dbg !875 {
  call void @__cxx_global_var_init(), !dbg !877
  ret void
}
...
!7 = distinct !DICompileUnit(language: DW_LANG_C_plus_plus_14, file: !8, producer: "Ubuntu clang version 14.0.6", isOptimized: false, runtimeVersion: 0, emissionKind: FullDebug, globals: !9, imports: !10, splitDebugInlining: false, nameTableKind: None)
!8 = !DIFile(filename: "/home/bflin/gaps/cpp-closure/build/capo/tests/cpp/hello_world.cpp", directory: "/home/bflin/gaps/cpp-closure/build/capo/tests", checksumkind: CSK_MD5, checksum: "fd5182c22933f3c0659599cd650b328d")
!9 = !{!0}
...
!136 = !DIFile(filename: "cpp/hello_world.cpp", directory: "/home/bflin/gaps/cpp-closure/build/capo/tests")
...
!858 = !{i32 7, !"PIC Level", i32 2}
!859 = !{i32 7, !"PIE Level", i32 2}
!860 = !{i32 7, !"uwtable", i32 1}
!861 = !{i32 7, !"frame-pointer", i32 2}
!862 = !{!"Ubuntu clang version 14.0.6"}
!863 = distinct !DISubprogram(name: "__cxx_global_var_init", scope: !136, file: !136, type: !464, flags: DIFlagArtificial, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !7, retainedNodes: !864)
!864 = !{}
!865 = !DILocation(line: 74, column: 25, scope: !866)
!866 = !DILexicalBlockFile(scope: !863, file: !3, discriminator: 0)
!867 = !DILocation(line: 0, scope: !863)
!868 = distinct !DISubprogram(name: "main", scope: !869, file: !869, line: 5, type: !547, scopeLine: 5, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !7, retainedNodes: !864)
!869 = !DIFile(filename: "cpp/hello_world.cpp", directory: "/home/bflin/gaps/cpp-closure/build/capo/tests", checksumkind: CSK_MD5, checksum: "fd5182c22933f3c0659599cd650b328d")
!870 = !DILocalVariable(name: "x", scope: !868, file: !869, line: 7, type: !19)
!871 = !DILocation(line: 7, column: 9, scope: !868)
!872 = !DILocation(line: 9, column: 15, scope: !868)
!873 = !DILocation(line: 9, column: 32, scope: !868)
!874 = !DILocation(line: 11, column: 5, scope: !868)
!875 = distinct !DISubprogram(linkageName: "_GLOBAL__sub_I_hello_world.cpp", scope: !136, file: !136, type: !876, flags: DIFlagArtificial, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !7, retainedNodes: !864)
!876 = !DISubroutineType(types: !864)
